                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="Global IME Bank"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Nepal Credit and Commerce Bank"></asp:ListItem>
                                <asp:ListItem Value="3" Text="NABIL Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Nepal Rastra Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Standard Chartered Bank"></asp:ListItem>
                            </asp:DropDownList>
